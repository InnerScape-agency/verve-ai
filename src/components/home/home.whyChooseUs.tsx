        ...
        <div className="flex items-stretch justify-between">
          ...
          <div className="flex w-full max-w-130 flex-col items-start justify-between">
            <SectionHeader
              varient="light"
              alingMent="left"
              semiTitle="Why Choose Us?"
              title="Why Candidates Choose Verve AI"
              svg={
                <svg
                  width="20"
                  height="20"
            ...
            <div className="flex w-full max-w-130 items-center justify-between">
              ...
              <div className="flex flex-col gap-4">
                <p className="font-inter text-dark-900 text-base">Active Candidates</p>

                <h3 className="font-jakarta text-dark text-[56px] leading-16 font-medium">
                  <span>50</span>K
                </h3>
              </div>

              <div className="border-dark-200 h-4/5 border" />

              <div className="flex flex-col gap-4">
                <p className="font-inter text-dark-900 text-base">Monthly Visitors</p>
