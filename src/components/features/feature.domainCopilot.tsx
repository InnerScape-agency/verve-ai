...
import { domainCopilots } from '@/constant/domainCopilots/domainCopilots'
import DomainCopilotCard from './domainCopilot.card'
import clsx from 'clsx'

export default function FeatureDomainCopilot() {
  return (
      ...
      >
        <div className="w-full">
          <div className="space-y-16">
            <SectionHeader
              semiTitle="Domain Copilot Marketplace"
              title="Specialized Copilot for Your Role & Industry"
              svg={
                <svg
                  width="20"
                  height="20"
            ...
            <div className="overflow-x-scroll">
              <div className="flex w-fit gap-5">
                {domainCopilots.map((domainCopilot) => (
                  <DomainCopilotCard key={domainCopilot.title} data={domainCopilot} />
                ))}
              </div>
            </div>
          </div>
